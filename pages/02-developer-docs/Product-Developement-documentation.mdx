...
# Product Developement Documentation
...
This guide is intended as an overview from choosing a project right through to release. For the quick start in Cursor building fast guide, see: 
...
Vercel's templates are perfect starting points—*not* over-stacked boilers—just the bare bones: [vercel.com/templates/supabase-auth](https://vercel.com/templates/supabase-auth) (for example).  
...
You can follow this with ChatGPT prompts—getting everything working is the first step. 
...
# Try this out: [https://m.youtube.com/watch?v=JfMcFjD-tIA&pp=0gcJCd4JAYcqIYzv](https://m.youtube.com/watch?v=JfMcFjD-tIA&pp=0gcJCd4JAYcqIYzv) 
...
I used to be a huge fan of [storybook.js.org](https://storybook.js.org/)—if I were building a long-lasting project with a design system, I'd get into this. Take an **atomic** approach—build from atoms to larger design components, then link back to Figma for a design system and an app that can scale.
