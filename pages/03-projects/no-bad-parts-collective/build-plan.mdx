...
|**1.5 Git repo**|`git clone git@github.com:charlieellington/no-bad-parts-landing.git``git remote set-url origin git@github.com:<PRIVATE-ORG>/no-bad-parts-landing.git` (make it private)|
